        ...
        static void Main(string[] args)
        {
            ...
            switch (option)
            {
                case 1:
                    ...
                    Console.WriteLine($"Your weight is approximately {weightOnPlanet}kgs on Mercury.");
                    break;
                case 2:
                    gravitationalRatio = 0.91;
                    weightOnPlanet = gravitationalRatio * weight;
                    Console.WriteLine($"Your weight is approximately {weightOnPlanet}kgs on Venus.");
                    break;
                case 3:
                    gravitationalRatio = 1;
                    weightOnPlanet = gravitationalRatio * weight;
                    Console.WriteLine($"Your weight is approximately {weightOnPlanet}kgs on Earth.");
                    break;
                case 4:
                    gravitationalRatio = 0.38;
                    weightOnPlanet = gravitationalRatio * weight;
                    Console.WriteLine($"Your weight is approximately {weightOnPlanet}kgs on Mars.");
                    break;
                case 5:
                    gravitationalRatio = 2.34;
                    weightOnPlanet = gravitationalRatio * weight;
                    Console.WriteLine($"Your weight is approximately {weightOnPlanet}kgs on Jupiter.");
                    break;
                case 6:
                    gravitationalRatio = 1.06;
                    weightOnPlanet = gravitationalRatio * weight;
                    Console.WriteLine($"Your weight is approximately {weightOnPlanet}kgs on Saturn.");
                    break;
                case 7:
                    gravitationalRatio = 0.92;
                    weightOnPlanet = gravitationalRatio * weight;
                    Console.WriteLine($"Your weight is approximately {weightOnPlanet}kgs on Uranus.");
                    break;
                case 8:
                    gravitationalRatio = 1.19;
                    weightOnPlanet = gravitationalRatio * weight;
                    Console.WriteLine($"Your weight is approximately {weightOnPlanet}kgs on Neptune.");
                    break;
                case 9:
                    gravitationalRatio = 0.06;
                    weightOnPlanet = gravitationalRatio * weight;
                    Console.WriteLine($"Your weight is approximately {weightOnPlanet}kgs on Pluto.");
                    break;
